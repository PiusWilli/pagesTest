...
--><html><head>
  ...
  <meta charset="UTF-8">
    ...
    <script type="text/javascript" src="../custom-elements-es5-adapter.js"></script>
    <!--! do not remove -->
<script src="../webcomponents-loader.js" defer=""></script>
  <script src="./wct-config.js"></script>
  <script>WCT.waitFor = (cb) => {addEventListener('WebComponentsReady', cb)}</script>
  <script src="../node_modules/wct-browser-legacy/browser.js"></script>
  <script type="module">
    WebComponents.waitFor(() => {
      return import('./modules/module-a.js');
    });
  </script>
</head>
